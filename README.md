...
| `get-drive-item` | Get file metadata |
| `download-drive-item` | Download file content |
| `upload-drive-item` | Upload a file |
| `create-drive-folder` | Create new folder |
| `delete-drive-item` | Delete file/folder |
| `search-drive-items` | Search for files |
...
| `search-people` | Search contacts and directory |
...
| `list-site-drive-items` | List site documents |
