...
# Create event
python3 ms365_cli.py calendar create --subject "Meeting" --start "2024-12-15T10:00:00" --end "2024-12-15T11:00:00" [--body "Description"] [--timezone "America/Chicago"]
```
...
# Create task
python3 ms365_cli.py tasks create LIST_ID --title "Task title" [--due "2024-12-20"]
```
